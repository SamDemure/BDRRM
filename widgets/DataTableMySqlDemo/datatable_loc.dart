                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSidebarButton('Vulnerability Assessment Index'),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: 'Municipality'),
                        ),
                        SizedBox(height: 8),
                        TextField(
                          controller: _evacuationsiteController,
                          decoration: InputDecoration(hintText: 'Evacuation Site'),
                        ),
                        SizedBox(height: 8),
                        TextField(
                          controller: _evacuationsiteHeadController,
                          decoration: InputDecoration(hintText: 'Evacuation Site Head'),
                        ),
                        SizedBox(height: 20),
                        _isUpdating
                            ? ElevatedButton(
